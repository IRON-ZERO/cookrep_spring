...
public class RecipeController {
	...
	public ResponseEntity<List<Map<String, String>>> getPresignedUrls(@RequestBody
	...
	public ResponseEntity<List<RecipeRecommendationResponseDTO>> findRecipesByIngredientIds(
		@RequestBody
		RecipeSearchByIngredientsRequestDTO recipeSearchByIngredientsRequestDTO,
		@AuthenticationPrincipal
		CustomUserDetail userDetails) {
